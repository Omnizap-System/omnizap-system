...
const PUBLIC_WHATSAPP_ENV_KEYS = ['WHATSAPP_PUBLIC_CONTACT_NUMBER', 'WHATSAPP_SUPPORT_NUMBER', 'EMAIL_BRAND_SUPPORT_PHONE', 'EMAIL_WELCOME_BOT_PHONE', 'WHATSAPP_BOT_NUMBER', 'BOT_NUMBER', 'BOT_PHONE_NUMBER', 'PHONE_NUMBER', 'OWNER_NUMBER'];
